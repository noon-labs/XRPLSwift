...
class xUInt64: xUInt {
    ...
    class func from(_ value: Int) throws -> xUInt64 {
        ...
        let valueBytes = Array(value.data).prefix(WIDTH64)
        return xUInt64(Array(valueBytes).reversed())
    }
    ...
    class func from(_ value: String) throws -> xUInt64 {
        ...
        let strBuf = value.padding(toLength: 16, withPad: "0", startingAt: 0)
        return xUInt64(strBuf.hexToBytes)
    }
}
