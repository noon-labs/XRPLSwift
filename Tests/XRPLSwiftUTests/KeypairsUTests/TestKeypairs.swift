...
final class TestApi: XCTestCase {
    ...
    func testGenerateSeedFromEntropySECP256K1() throws {
    ...
    func testGenerateSeedRandomSECP256K1() throws {
    ...
    func testGenerateSeedFromEntropyED25519() throws {
    ...
    func testGenerateSeedRandomED25519() throws {
    ...
    func testDeriveKeypairSECP256K1() throws {
    ...
    func testDeriveKeypairED25519() throws {
    ...
    func testDeriveKeypairSECP256K1Validator() throws {
    ...
    func testDeriveAddressED25519() throws {
    ...
    func testVerifySECP256K1() throws {
